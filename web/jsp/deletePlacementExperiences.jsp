...
<html>
  ...
  <body>
    ...
    <!--HTML code for the delete placement experiences-->
    <div class="delete">
        ...
        <!--HTML code to display the placement experiences added by the students-->
        <section>
                 ...
                 <%
                        ...
                        if (request.getParameter("search") == null) {
                            try {
                                ...
                                ResultSet rs = stmt.executeQuery("select e.eid, s.sname, e.company,e.position, e.verdict from student s, experience e where s.semailid = e.semailid and category='Placement' order by s.sname ASC");
                            ...
                            try {
                                ...
                                if (values.length == 0) {
                                    ...
                                    if (k > 0) {
                                        ...
                                        response.sendRedirect("deletePlacementExperiences.jsp");
                                    }
                                }
                                conn.close();
                            } catch (Exception ex) {
                   ...
                   <!--code to display searched records according to student emailid-->
                    <%
                            ...
                            if (request.getParameter("search") != null) {
                               ...
                               String query1="select e.eid,s.sname,e.company,e.position,e.verdict from experience e , student s where s.semailid=e.semailid and e.semailid='" + emailid + "' and e.category='Placement'";  
